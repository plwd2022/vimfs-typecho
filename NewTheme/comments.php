  ...
  <div id="<?php $this->respondId(); ?>" class="respond">
    ...
    <form method="post" action="<?php $this->commentUrl() ?>" id="comment-form">
      ...
      <p><?php _e('当前登录用户：'); ?><a href="<?php $this->options->profileUrl(); ?>"><?php $this->user->screenName(); ?></a> <a href="<?php $this->options->logoutUrl(); ?>" title="<?php _e('Logout'); ?>"><?php _e('退出'); ?></a></p>
      <?php else: ?>
      <p>
      ...
      <p>
        <span role="notify" tabindex="0"><?php _e('评论后，评论信息处于待审核状态，稍后我们会做出回复。'); ?></span>
      </p>
      <p>
