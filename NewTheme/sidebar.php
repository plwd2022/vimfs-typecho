<div id="rightbar" role="complementary">
    <div class="sidebar-inner">
        ...
        <aside class="widget widget_search">
            <h2 class="widget-title" accesskey="2"><?php _e('Search'); ?></h2>
            <form method="post" action="<?php $this->options->siteUrl(); ?>" role="search">
                <label for="s" class="sr-only"><?php _e('Search keywords'); ?></label>
                <input type="text" name="s" id="s" class="text" placeholder="<?php _e('Enter keywords...'); ?>" />
        ...
        <aside class="widget widget_recent_posts">
            <h2 class="widget-title" accesskey="2"><?php _e('Latest Articles'); ?></h2>
        ...
        <aside class="widget widget_recent_comments">
            <h2 class="widget-title" accesskey="2"><?php _e('Recent Replies'); ?></h2>
            <ul class="widget-list">
        ...
        <aside class="widget widget_categories">
            <h2 class="widget-title" accesskey="2"><?php _e('Categories'); ?></h2>
            <ul class="widget-list">
        ...
        <aside class="widget widget_archive">
            <h2 class="widget-title" accesskey="2"><?php _e('Archives'); ?></h2>
            <ul class="widget-list">
        ...
        <aside class="widget widget_links">
            <h2 class="widget-title" accesskey="2"><?php _e('Friendly Links'); ?></h2>
            <ul class="widget-list">
